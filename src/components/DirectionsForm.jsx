...
const DirectionsForm = ({ onSubmit, recommendedRoutes, setRecommendedRoutes, setSelectedRoute, handleConfirmRoute, setDirections }) => {
  ...
  return (
    <div className="max-w-sm mx-auto bg-white shadow-lg rounded-lg p-6 h-128 overflow-y-auto">
      <button onClick={toggleFormVisibility} className="mb-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
        {formVisible ? (
          // SVG for hiding
        ...
        <div>
          ...
          <div className="flex justify-end mt-5">
            <button
              type="button"
              onClick={handleBack}
              className="bg-gray-200 text-gray-700 py-2 px-4 rounded-full mr-2"
            >
              Volver
            </button>
            <button
