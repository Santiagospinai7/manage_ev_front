  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="max-w-xl p-8 bg-white rounded-lg shadow-xl">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-battery-automotive" width="72" height="72" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <h1 className="mb-4 text-2xl font-bold text-center text-gray-700 mx-10">Register to Manage Ev</h1>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <input type="number" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder="" />
        </div>
        <div className="mb-6">
        ...
        <p className="mb-6 text-center">
          <a className="text-sm text-blue-600 hover:underline" href="/user/login">already has an account</a>
        </p>
        <button onClick={handleLogin} className="w-full px-4 py-2 text-sm font-medium text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">Sign Up</button>
        <hr className="my-8" />
